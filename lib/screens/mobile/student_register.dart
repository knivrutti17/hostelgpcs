...
class _StudentRegisterState extends State<StudentRegister> {
  ...
  Future<void> _handleRegister() async {
    try {
      // Logic: Roll Number used as fake email for Firebase Auth
      ...
      if (mounted) {
        // Wipes navigation stack to prevent returning to registration
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: AppStyle.headerGradient, // Background gradient
        ),
        child: Center(
            ...
            child: Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(30), // Rounded card UI
                  boxShadow: [
                    BoxShadow(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          backgroundColor: AppStyle.primaryTeal, // Themed button
  ...
  Widget _buildInputField({
    ...
    return Container(
      ...
      decoration: AppStyle.cardDecoration, // Themed shadow effect
      child: TextField(
  ...
  Widget _buildBranchDropdown() {
    return Container(
      ...
      decoration: AppStyle.cardDecoration, // Consistent shadow
